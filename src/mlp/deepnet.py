...
class DeepNet(torch.nn.Module):
    def __init__(self, n_hidden_nodes, image_width, image_height, color_channels, n_classes, activation="None"):
        ...
        self.hidden_layer2 = torch.nn.Linear(self.n_hidden_nodes, self.n_hidden_nodes)
        # self.hidden_layer3 = torch.nn.Linear(self.n_hidden_nodes, self.n_hidden_nodes)
